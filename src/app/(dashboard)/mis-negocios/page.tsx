...
import { Briefcase, Receipt, Zap, AlertCircle } from "lucide-react";
...
async function Dashboard() {
  try {
    ...
    console.error("[mis-negocios] Dashboard render error:", err);
    return (
      <div className="flex h-full items-center justify-center p-8">
        <div className="max-w-sm w-full text-center space-y-6">
          ...
          <div className="space-y-2">
            <h2 className="text-xl font-bold text-gray-900">Error al cargar el dashboard</h2>
            <p className="text-gray-500 text-sm">
              Algo salió mal al cargar tu información. Intenta recargar la página.
            </p>
          </div>
          <Link
            href="/mis-negocios"
